...
type Language = "zh" | "en";
type ViewKey = "dashboard" | "runtime" | "models" | "settings" | "logs";
type Health = { status: string; service: string; version: string; runtime: string; uptime_seconds: number };

const dictionaries = {
  zh: {
    subtitle: "开源 AI Runtime",
    alpha: "Alpha 0.3 · 液态玻璃控制台",
    online: "在线",
    checking: "检查中",
    switchLanguage: "EN",
    nav: { dashboard: "仪表盘", runtime: "运行时", models: "模型", settings: "设置", logs: "日志" },
  ...
  en: {
    ...
    alpha: "Alpha 0.3 · Liquid Glass Console",
    online: "Online",
    checking: "Checking",
    switchLanguage: "中文",
    nav: { dashboard: "Dashboard", runtime: "Runtime", models: "Models", settings: "Settings", logs: "Logs" },
