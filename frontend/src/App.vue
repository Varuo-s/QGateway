  ...
  <el-container class="app-shell">
    ...
    <el-container class="main-shell">
      ...
      <el-main class="content">
        ...
        <ClientsView v-else-if="activeView === 'clients'" :labels="t.clients" />
...
type Language = "zh" | "en";
type ViewKey = "dashboard" | "runtime" | "models" | "playground" | "clients" | "settings" | "logs";
type Health = { status: string; service: string; version: string; runtime: string; uptime_seconds: number };

const dictionaries = {
  zh: {
    subtitle: "开源 AI Runtime",
    alpha: "Alpha 0.6 · 液态玻璃控制台",
    online: "在线",
    checking: "检查中",
    switchLanguage: "EN",
    nav: { dashboard: "仪表盘", runtime: "运行时", models: "模型", playground: "Playground", clients: "客户端", settings: "设置", logs: "日志" },
    ...
    runtime: { title: "运行时", subtitle: "管理 llama.cpp 服务", start: "启动", stop: "停止", refresh: "刷新", save: "保存", state: "状态", provider: "Provider", pid: "PID", endpoint: "端点", executable: "可执行文件", model: "模型", command: "启动命令", exists: "存在", missing: "缺失", error: "错误", running: "运行中", stopped: "已停止", unknown: "未知", runtimeConfig: "运行参数", alias: "模型别名", host: "监听地址", localOnly: "仅本机", lan: "局域网", port: "端口", gpuLayers: "GPU Layers", context: "Context", flashAttention: "Flash Attention", reasoning: "思考模式", reasoningFormat: "思考格式", logColors: "日志颜色", extraArgs: "额外参数" },
    ...
    clients: { title: "客户端", subtitle: "生成 OpenAI 兼容客户端配置", refresh: "刷新", copy: "复制", download: "下载" },
  ...
  en: {
    ...
    alpha: "Alpha 0.6 · Liquid Glass Console",
    online: "Online",
    checking: "Checking",
    switchLanguage: "中文",
    nav: { dashboard: "Dashboard", runtime: "Runtime", models: "Models", playground: "Playground", clients: "Clients", settings: "Settings", logs: "Logs" },
    ...
    runtime: { title: "Runtime", subtitle: "Manage llama.cpp service", start: "Start", stop: "Stop", refresh: "Refresh", save: "Save", state: "State", provider: "Provider", pid: "PID", endpoint: "Endpoint", executable: "Executable", model: "Model", command: "Command", exists: "Exists", missing: "Missing", error: "Error", running: "Running", stopped: "Stopped", unknown: "Unknown", runtimeConfig: "Runtime Config", alias: "Model Alias", host: "Host", localOnly: "Local only", lan: "LAN", port: "Port", gpuLayers: "GPU Layers", context: "Context", flashAttention: "Flash Attention", reasoning: "Reasoning", reasoningFormat: "Reasoning Format", logColors: "Log Colors", extraArgs: "Extra Args" },
    ...
    clients: { title: "Clients", subtitle: "Generate OpenAI-compatible client configs", refresh: "Refresh", copy: "Copy", download: "Download" },
...
const navItems = computed(() => [
  ...
  { key: "clients" as const, label: t.value.nav.clients },
